-- SAFE DATABASE SETUP - CHECKS FOR EXISTING POLICIES
...
-- ===========================================
-- 4. CREATE STORAGE BUCKETS (SAFELY)
-- ===========================================
...
DROP POLICY IF EXISTS "Authenticated users can upload public event images" ON storage.objects;
DROP POLICY IF EXISTS "Anyone can view public event images" ON storage.objects;
DROP POLICY IF EXISTS "Users can delete their own public event images" ON storage.objects;
